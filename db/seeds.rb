...
event_two = Event.create(
    category_id: concerts.id,
    image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4yDfsDIwicd-12W6lc7uV4gcmZONtLhjGc-lKIbHZFg&s=10",
    name: "The Weekend",
    summary: "Buy The Weeknd, T-Mobile Center Tickets for Sat Feb 19 2022",
    when: "Sat, Feb 19",
    time: "TBD",
